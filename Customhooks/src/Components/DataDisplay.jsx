...
function DataDisplay(){
    ...
    return (
        <div>
          <h1 className="text-white flex justify-center m-7 text-5xl">Photos</h1>
          ...
          <ul className="flex flex-wrap justify-center w-full">
            {
              data.map((items)=>(
                <li  >
                  <div className="border-2 border-white w-80 h-64 m-1 p-4 flex justify-center flex-wrap">
                    <div 
                     className="text-gray-600 w-40 h-40 flex justify-center items-center m-2"
